...
static struct option long_options[] =
{
    ...
    {"rpop", required_argument, 0, 'e'},
    {"tsize", required_argument, 0, 'f'},
    {"elirate", required_argument, 0, 'g'},
    {"mutrate", required_argument, 0, 'h'},
    {"grepsize", required_argument, 0, 'i'},
    {"greprate", required_argument, 0, 'j'},
    {"crosstype", required_argument, 0, 'k'},
    {"popcheckpt", required_argument, 0, 'l'},
